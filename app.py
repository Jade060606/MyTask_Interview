...
def is_bookable(item):
    """Equipment can only be booked/shown as available when it isn't under maintenance."""
...
def rental_days(from_date, to_date):
    ...
    Billing is inclusive of both the start and end day, so a same-day
    rental (from_date == to_date) counts as 1 day.
    """
